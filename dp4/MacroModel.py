...
def SetupMacroModel(settings):
    ...
    for f in settings.InputFiles:
        ...
        if settings.Rot5Cycle is True:
            print('This release of DP4 does not support 5m rings.')
            quit()
        ...
        default_com_path = pkg_resources.resource_filename(__name__, 'data/default.com')
        shutil.copyfile(default_com_path, cwd + '/' + f + '.com')
